...
sequence_length = 384  # keep small for EZKL
...
if use_wrapper := True: #set to True to for working with ezkl
    save_input_path = "examples/onnx/bert/bert_large_squad_input.json"
    save_onnx_path = "examples/onnx/bert/bert_large_squad.onnx"
